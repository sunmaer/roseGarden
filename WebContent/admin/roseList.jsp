...
<div id="container" class="container">
  ...
  <div class="main">
    ...
    <div class="main-box">
      ...
      <div class="search">
      	<form id="table-class" method="post" action="roseList">
      		<select id="classification" name="type">
          		<option value="">未选择</option>
          		<option value="所有月季">所有月季</option>
      ...
      <table class="list">
      	...
      	<c:forEach items="${requestScope.roselist}" var="rose" varStatus="status" >
	       <c:if test="${status.count%2==0}" >
               <tr style="background-color: #F0F0F0; ">       
     	 	  <td><input type="checkBox"></td>
              <td style="display:none;">${rose.rid}</td>
              <td>${status.count}</td>
              <td>${rose.specie }</td>
