...
<div id="container" class="container">
  <p class="path">
    ...
    <span>蔷薇花园 管理中心
	    ...
	    <i class="fa fa-angle-right fa-lg"></i> 月季编辑
    </span>
  </p>
  <div class="main">
    <div class="main-box">
      ...
      <div class="description">
        <p>
        	你可以在本版块修改  <strong>${rose.specie}</strong> 月季信息，请修改具体的月季性状，还可以上传月季照片。
        </p>
      </div> <!-- description -->
    </div> <!-- main-box -->
 
    <div class="main-box">
      <div class="box-title">月季编辑
		<!-- <a class="add" href=""> <i class="fa fa-plus"></i> &nbsp;增加月季</a> -->
      </div>
      <form id="roseForm" enctype="multipart/form-data">
      
      <!-- 给后台传rid -->
      <span style="display: none;" id="rid">${rose.rid}</span>
      
      <table class="addRose list">
        <tr>
          <td>品种名</td>
          <td>
          	<input value="${rose.specie}" id="specie" disabled name="specie" type="text" placeholder="请输入品种名">
          ...
          <td>
          	<select id="classification" name="classification">
          		<option style="display: none;" value="${rose.classification}">${rose.classification}</option>
        ...
        <tr>
          ...
          <td>
          	<select id="nowrose" name="nowrose">
          		<option style="display: none;" value="${rose.nowrose}">${rose.nowrose}</option>	
          		<option value="">未选择</option>
          ...
          <td>培育地</td>
          <td><input value="${rose.cultivate}" id="cultivate" type="text" name="cultivate" placeholder="请输入培育地"></td>
        </tr>

        <tr>
          <td>引种地</td>
          <td><input value="${rose.introduction}" id="Introduction" type="text" name="introduction" placeholder="请输入引种地"></td>
          <td>株型</td>
          <td>
          	<select id="type" name="type">
          		<option style="display: none;" value="${rose.type}">${rose.type}</option>
          		<option value="">未选择</option>
        ...
        <tr>
          ...
          <td>
          	<select id="growthpotential" name="growthpotential">
          		<option style="display: none;" value="${rose.growthpotential}">${rose.growthpotential}</option>
          		<option value="">未选择</option>
          ...
          <td>
          	<select id="height" name="height">
          		<option style="display: none;" value="${rose.height}">${rose.height}</option>
          		<option value="">未选择</option>
        ...
        <tr>
          <td>茎干粗度</td>
          <td><input value="${rose.stemroughness}" id="stemroughness" type="text" name="stemroughness" placeholder="请输入茎干粗度"></td>
          <td>节间长</td>
          <td>
          	<select id="sectionlong" name="sectionlong">
          		<option style="display: none;" value="${rose.sectionlong}">${rose.sectionlong}</option>
		  		<option value="">未选择</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="isbranchestraight" name="isbranchestraight">
		  		<option style="display: none;" value="${rose.isbranchestraight}">${rose.isbranchestraight}</option>
		  		<option value="">未选择</option>
		  ...
		  <td>
		  	<select id="branchangle" name="branchangle">
		  		<option style="display: none;" value="${rose.branchangle}">${rose.branchangle}</option>
		  		<option value="">未选择</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="twigscolor" name="twigscolor">
		  		<option style="display: none;" value="${rose.twigscolor}">${rose.twigscolor}</option>
		  		<option value="">未选择</option>
		  ...
		  <td>
		  	<select id="hasthorn" name="hasthorn">
		  		<option style="display: none;" value="${rose.hasthorn}">${rose.hasthorn}</option>
		  		<option value="">未选择</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="thornshape" name="thornshape">
		  		<option style="display: none;" value="${rose.thornshape}">${rose.thornshape}</option>
		  		<option value="">未选择</option>
		  ...
		  <td>
		  	<select id="thorndensity" name="thorndensity">
		  		<option style="display: none;" value="${rose.thorndensity}">${rose.thorndensity}</option>
		  		<option value="">未选择</option>
		...
		<tr>
          ...
          <td>
          	<select  id="longthornnumber" name="longthornnumber">
          		<option style="display: none;" value="${rose.longthornnumber}">${rose.longthornnumber}</option>
		  		<option value="">未选择</option>
		  		<option value="无">无</option>
          ...
          <td>
          	<select  id="shortthornnumber" name="shortthornnumber">
          		<option style="display: none;" value="${rose.shortthornnumber}">${rose.shortthornnumber}</option>
		  		<option value="">未选择</option>
		  		<option value="无">无</option>
		  		<option value="少">少</option>
		  		<option value="中">中</option>
        ...
        <tr>
          ...
          <td>
          	<select id="lobularnumber" name="lobularnumber">
          		<option style="display: none;" value="${rose.lobularnumber}">${rose.lobularnumber}</option>
		  		<option value="">未选择</option>
		  ...
		  <td>
		  	<select id="lobularshape" name="lobularshape">
		  		<option style="display: none;" value="${rose.lobularshape}">${rose.lobularshape}</option>
		  		<option value="">未选择</option>
        ...
        <tr>
          ...
          <td>
          	<select id="leafarea" name="leafarea">
          		<option style="display: none;" value="${rose.leafarea}">${rose.leafarea}</option>
		  		<option value="">未选择</option>
          ...
          <td>顶端小叶长</td>
          <td><input value="${rose.topleafletslong}" id="topleafletslong" type="text" name="topleafletslong" placeholder="请输入数值"></td>
          
        </tr>

        <tr>
          <td>顶端小叶宽</td>
          <td><input value="${rose.topleafletswide}" id="topleafletswide" type="text" name="topleafletswide" placeholder="请输入数值"></td>
          <td>顶端小叶长宽比</td>
          <td><input value="${rose.topleaflets}" id="topleaflets" type="text" name="topleaflets" placeholder="请输入顶端小叶长宽比"></td>
		</tr>
		...
		<tr>
		  ...
		  <td>
		  	<select id="leaftexture" name="leaftexture">
		  		<option style="display: none;" value="${rose.leaftexture}">${rose.leaftexture}</option>
		  		<option value="">未选择</option>
		  ...
		  <td>
		  	<select id="leaveluster" name="leaveluster">
		  		<option style="display: none;" value="${rose.leaveluster}">${rose.leaveluster}</option>
		  		<option value="">未选择</option>
		  		<option value="强">强</option>
		  		<option value="中">中</option>
		  		<option value="弱">弱</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="newleafcolor" name="newleafcolor">
		  		<option style="display: none;" value="${rose.newleafcolor}">${rose.newleafcolor}</option>
		  		<option value="">未选择</option>
		  		<option value="绿色">绿色</option>
		  		<option value="红色">红色</option>
		  		<option value="其他">其他</option>
		  ...
		  <td>
		  	<select id="oldleafcolor" name="oldleafcolor">
		  		<option style="display: none;" value="${rose.oldleafcolor}">${rose.oldleafcolor}</option>
		  		<option value="">未选择</option>
		  		<option value="绿色">绿色</option>
		  		<option value="红色">红色</option>
		  		<option value="其他">其他</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="serrat" name="serrat">
		  		<option style="display: none;" value="${rose.serrat}">${rose.serrat}</option>
		  		<option value="">未选择</option>
          ...
          <td>
		  	<select id="flowertime" name="flowertime">
		  		<option style="display: none;" value="${rose.flowertime}">${rose.flowertime}</option>
		  		<option value="">未选择</option>
        ...
        <tr> 
          <td>始花期</td>
          <td><input value="${rose.flowerstart}" id="flowerstart" type="text" name="flowerstart" placeholder="请输入始花期"></td>
          <td>盛花期</td>
          <td><input value="${rose.flowerbloom}" id="flowerbloom" type="text" name="flowerbloom" placeholder="请输入盛花期"></td>
        </tr>
		
		<tr>
          <td>末花期</td>
          <td><input value="${rose.flowerend}" id="flowerend" type="text" name="flowerend" placeholder="请输入末花期"></td>
          <td>单朵花花期</td>
		  <td>
          	<input value="${rose.singleflowerperiod}" id="singleflowerperiod" type="text" name="singleflowerperiod" placeholder="请输入数值">
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
		  	<select id="floweramount" name="floweramount">
		  		<option style="display: none;" value="${rose.floweramount}">${rose.floweramount}</option>
		  		<option value="">未选择</option>
		  		<option value="大">大</option>
		  		<option value="中">中</option>
		  		<option value="小">小</option>
		  ...
		  <td>
		  	<select id="inflorescence" name="inflorescence">
		  		<option style="display: none;" value="${rose.inflorescence}">${rose.inflorescence}</option>
		  		<option value="">未选择</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="flowercolor" name="flowercolor">
		  		<option style="display: none;" value="${rose.flowercolor}">${rose.flowercolor}</option>
		  		<option value="">未选择</option>
		  ...
		  <td>
		  	<select id="singleColor" name="singlecolor">
		  		<option style="display: none;" value="${rose.singlecolor}">${rose.singlecolor}</option>
		  		<option value="">未选择</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="multiplyColor" name="multiplycolor">
		  		<option style="display: none;" value="${rose.multiplycolor}">${rose.multiplycolor}</option>
		  		<option value="">未选择</option>
          ...
          <td>
		  	<select id="floral" name="floral">
		  		<option style="display: none;" value="${rose.floral}">${rose.floral}</option>
		  		<option value="">未选择</option>
		  		<option value="无">无</option>
        ...
        <tr>
          <td>花径</td>
          <td><input value="${rose.flowerdiameter}" id="flowerdiameter" type="text" name="flowerdiameter" placeholder="请输入(cm)"></td>
          <td>单重瓣</td>
          <td>
          	<select id="singledoublepetal" name="singledoublepetal">
          		<option style="display: none;" value="${rose.singledoublepetal}">${rose.singledoublepetal}</option>
		  		<option value="">未选择</option>
        ...
        <tr>
          ...
          <td>
		  	<select id="flowerpattern" name="flowerpattern">
		  		<option style="display: none;" value="${rose.flowerpattern}">${rose.flowerpattern}</option>
		  		<option value="">未选择</option>
          ...
          <td>
		  	<select id="flowereye" name="flowereye">
		  		<option style="display: none;" value="${rose.flowereye}">${rose.flowereye}</option>
		  		<option value="">未选择</option>
		  		<option value="无">无</option>
        ...
        <tr>
		  ...
		  <td>
		  	<select id="flowerroll" name="flowerroll">
		  		<option style="display: none;" value="${rose.flowerroll}">${rose.flowerroll}</option>
		  		<option value="">未选择</option>
		  ...
		  <td>
		  	<select id="petalshape" name="petalshape">
		  		<option style="display: none;" value="${rose.petalshape}">${rose.petalshape}</option>
		  		<option value="">未选择</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="petalvelvet" name="petalvelvet">
		  		<option style="display: none;" value="${rose.petalvelvet}">${rose.petalvelvet}</option>
		  		<option value="">未选择</option>
		  		<option value="有">有</option>
		  		<option value="无">无</option>
		  	</select>
		  ...
		  <td>
		  	<select id="petalshardness" name="petalshardness">
		  		<option style="display: none;" value="${rose.petalshardness}">${rose.petalshardness}</option>
		  		<option value="">未选择</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="firmness" name="firmness">
		  		<option style="display: none;" value="${rose.firmness}">${rose.firmness}</option>
		  		<option value="">未选择</option>
		  ...
		  <td>
		  	<select id="pollenamount" name="pollenamount">
		  		<option style="display: none;" value="${rose.pollenamount}">${rose.pollenamount}</option>
		  		<option value="">未选择</option>
		  		<option value="多">多</option>
		  		<option value="中">中</option>
		  		<option value="少">少</option>
		...
		<tr>
          <td>花粉活力</td>
		  <td>
          	<input value="${rose.pollenvitality}" id="pollenvitality" type="text" name="pollenvitality" placeholder="请输入数值(%)">
          </td>
          <td>田间综合表现</td>
		  <td>
		  	<select id="fieldperformance" name="fieldperformance">
		  		<option style="display: none;" value="${rose.fieldperformance}">${rose.fieldperformance}</option>
		  		<option value="">未选择</option>
		  		<option value="强">强</option>
		  		<option value="中">中</option>
		  		<option value="弱">弱</option>
		...
		<tr>
		  ...
		  <td>
		  	<select id="heatresistance" name="heatresistance">
		  		<option style="display: none;" value="${rose.heatresistance}">${rose.heatresistance}</option>
		  		<option value="">未选择</option>
		  		<option value="强">强</option>
		  		<option value="中">中</option>
		  		<option value="弱">弱</option>
          ...
          <td>
		  	<select id="coldresistance" name="coldresistance">
		  		<option style="display: none;" value="${rose.coldresistance}">${rose.coldresistance}</option>
		  		<option value="">未选择</option>
		  		<option value="强">强</option>
		  		<option value="中">中</option>
		  		<option value="弱">弱</option>
		...
		<tr>
          ...
          <td>
          	<select id="powderymildew" name="powderymildew">
          		<option style="display: none;" value="${rose.powderymildew}">${rose.powderymildew}</option>
		  		<option value="">未选择</option>
		  		<option value="强">强</option>
		  		<option value="中">中</option>
		  		<option value="弱">弱</option>
          ...
          <td>
          	<select id="blackspot" name="blackspot">
          		<option style="display: none;" value="${rose.blackspot}">${rose.blackspot}</option>
		  		<option value="">未选择</option>
		  		<option value="强">强</option>
		  		<option value="中">中</option>
		  		<option value="弱">弱</option>
		  ...
		  <td colspan="3" class="td-picture">
		  	...
		  	<div id="showPicture">
		  		<c:forEach items="${requestScope.path}" var="item" >
	      			<div class="item">
		  				<img src="${item}" alt="${item}" /><div class="action">
		  					<a href="javascript:void(0);" title="查看大图"><i  class="fa fa-eye fa-lg"></i></a>
		  					<a href="javascript:void(0);" path="${item}" title="删除图片"><i  class="fa fa-remove fa-lg fileDelete"></i></a>
		  				</div>
		  			</div>
	     		</c:forEach>
		  	</div>
		...
		<tr>
		  ...
		  <td colspan="3">
		  	<textarea name="remark" id="remark">${rose.remark}</textarea>
		  </td>
		</tr>
...
//删除图片
showPicture.addEventListener("click",function(e) {
	e = e || window.event;
    var t = e.target || e.srcElement;  //t:目标对象
    var className = t.className;//class名称
    var tagName = t.tagName;
    if(className == "fa fa-remove fa-lg fileDelete") {
    	var XHR = new XMLHttpRequest();
    	XHR.open("post","fileDelete",true);
    	var formData = new FormData();
    	var path = t.parentNode.getAttribute("path");
    	console.log(path);
